...
@auth
<li class="nav-item">
    <a class="nav-link {{ Route::currentRouteName() == 'change-password' ? 'active' : '' }}" href="{{ route('change-password') }}">
...
@endauth
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.sucursals.*') ? 'active' : '' }}" 
                    href="{{ route('admin.sucursals.index') }}">
                <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'profile' ? 'active' : '' }}" href="{{ route('profile') }}">
                    ...
                    <span class="nav-link-text ms-1">Usuaarios</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'user-management') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'user-management']) }}">
