                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <p class="mb-0">
                                        <a href="{{ url('/admin/productos/create') }}" class="text-primary text-sm font-weight-bolder">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <p class="mb-0">
                                        <a href="{{ url('/admin/compras/create') }}" class="text-primary text-sm font-weight-bolder">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <p class="mb-0">
                                        <a href="{{ url('/admin/ventas/create') }}" class="text-primary text-sm font-weight-bolder">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <p class="mb-0">
                                        <a href="{{ url('/admin/clientes') }}" class="text-primary text-sm font-weight-bolder">
 ...
 <div class="row">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $product->total_cantidad < 3 ? 'bg-danger-soft' : ($product->total_cantidad < 5 ? 'bg-warning-soft' : 'bg-info-soft') }}">
                            <td class="ps-3">
                                <div class="media align-items-center">
                                    <div class="avatar bg-danger-light text-danger rounded-circle mr-2" style="width: 24px; height: 24px;">
                                        <i class="fas fa-box fs-6"></i>
                                    </div>
                                    <div class="media-body">
                                        <span class="mb-0" style="font-size: 0.85rem; font-weight: 500;">{{ $product->nombre }}</span>
                                        <small class="d-block text-muted" style="font-size: 0.7rem;">Código: {{ $product->codigo ?? 'N/A' }}</small>
                                    </div>
                                </div>
                            </td>
                            <td class="text-center">
                                <span class="font-weight-bold text-{{ $product->total_cantidad < 3 ? 'danger' : ($product->total_cantidad < 5 ? 'warning' : 'info') }}" style="font-size: 0.85rem;">
    ...
    <div class="card shadow border-0 success-card">
        <div class="card-body text-center p-3">
            ...
            <p class="mb-0 text-muted" style="font-size: 0.85rem;">Todos los productos tienen niveles adecuados</p>
        </div>
    </div>
    @endif
</div>
