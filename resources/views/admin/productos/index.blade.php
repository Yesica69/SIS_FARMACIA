        ...
        <div class="row align-items-center">
                        ...
                        <div class="d-flex flex-wrap align-items-center stats-container">
                            <div class="stat-item mr-4 mb-2 mb-md-0">
                                <span class="badge badge-light text-orange">
                                    ...
                                    <span class="font-weight-bold">{{ count($productos) }}</span> productos registrados
                                </span>
                            </div>
                            <div class="stat-item">
                                <span class="badge badge-light text-primary">
                                    <i class="fas fa-layer-group mr-1"></i> 
                                    <span class="font-weight-bold">{{ count($categorias) }}</span> categorías
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <a href="{{ url('/admin/productos/create') }}" 
                   class="btn btn-block btn-primary btn-hover-scale py-2 px-3"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-4 producto-card" data-category="{{ $producto->categoria_id }}">
                                <div class="card card-lift--hover shadow-sm h-100">
                                    ...
                                    <div class="card-body pt-3 pb-2">
                                       <h5 class="card-title mb-1 fs-6 text-xs text-dark">{{ $producto->nombre }}</h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="card-footer bg-transparent pt-0 pb-3 border-0">
                                        <div class="d-flex justify-content-between">
                                           <button type="button" 
                                                    class="btn btn-sm btn-outline-info rounded- me-2"
                                            ...
                                            data-producto='{"nombre":"{{ $producto->nombre }}"}'>
                                                ...
                                                <button type="button" 
                                                     ...
                                                     <span class="btn-inner--icon">
                                                        <i class="fas fa-trash-alt" style="-webkit-text-stroke: 1px #dc3545; color: transparent;"></i>
                                                    </span>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content border-0">
            ...
            <div class="modal-footer border-0 pt-0">
                ...
                <button type="button" class="btn btn-primary" onclick="openModal('editarModal{{ $producto->id }}')" data-bs-dismiss="modal">
                    Editar Producto
                </button>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="stock_minimo" class="font-weight-bold text-black mb-1">
                                <i class="fas fa-exclamation-triangle mr-2" style="color: green;"></i>Stock Mínimo
                            </label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="stock_maximo" class="font-weight-bold text-black mb-1">
                                <i class="fas fa-warehouse mr-2" style="color: green;"></i>Stock Máximo
                            </label>
        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="precio_compra" class="font-weight-bold text-black mb-1">
                                <i class="fas fa-money-bill-wave mr-2" style="color: green;"></i>Precio de Compra
                            </label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text bg-success text-white">Bs</span>
                                </div>
                                <input type="number" step="0.01" class="form-control border-primary" name="precio_compra"
                                    value="{{ $lote ? $lote->precio_compra : '' }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="precio_venta" class="font-weight-bold text-black mb-1">
                                <i class="fas fa-tags mr-2" style="color: green;"></i>Precio de Venta
                            </label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text bg-success text-white">Bs</span>
                                </div>
                                <input type="number" step="0.01" class="form-control border-primary" name="precio_venta"
        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="fecha_ingreso" class="font-weight-bold text-black mb-1">
                                <i class="fas fa-calendar-plus mr-2" style="color: green;"></i> Fecha de Ingreso
                            </label>
                            <input type="date" class="form-control border-primary" name="fecha_ingreso" 
                                value="{{ $lote ? \Carbon\Carbon::parse($lote->fecha_ingreso)->format('Y-m-d') : '' }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="fecha_vencimiento" class="font-weight-bold text-black mb-1">
                                <i class="fas fa-calendar-times mr-2" style="color: green;"></i> Fecha de Vencimiento
                            </label>
                            <input type="date" class="form-control border-primary" name="fecha_vencimiento" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="cantidad" class="font-weight-bold text-black mb-1">
                                <i class="fas fa-boxes mr-2" style="color: green;"></i>Cantidad en Lote
                            </label>
                            <input type="number" class="form-control border-primary" name="cantidad" 
                                value="{{ $lote ? $lote->cantidad : '' }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            <div class="file-upload-wrapper">
                                ...
                                <label for="imagen{{ $producto->id }}" class="file-upload-label bg-light-success text-black d-flex flex-column align-items-center justify-content-center" 
                                    style="border: 2px dashed green; border-radius: 0.5rem; padding: 1.5rem; cursor: pointer; transition: all 0.3s;">
                                    <i class="fas fa-cloud-upload-alt mb-2" style="font-size: 1.5rem; color: green;"></i>
...
<style>
    ...
    .form-control:focus, .form-control-border-primary:focus {
