                            ...
                            <div class="card bg-gradient-primary shadow">
                                <div class="card-body py-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <h3 class="text-white mb-0">Gestión de Prod</h3>
                                ...
                                <div class="card-footer bg-transparent pt-0 pb-3 border-0">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <button type="button" class="btn btn-sm btn-warning btn-icon-only rounded-circle shadow" 
                                                onclick="openModal('editarModal{{ $producto->id }}')"
                                                title="Editar">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        
                                        <!-- Botón Eliminar -->
                                        <button type="button" class="btn btn-sm btn-danger btn-icon-only rounded-circle shadow" 
...
<!-- Modales - Fuera del loop para evitar duplicados -->
@foreach($productos as $producto)
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="deleteForm" method="POST">
                ...
                @method('DELETE')
                <div class="modal-body">
                    <p id="deleteMessage">¿Estás seguro de eliminar este producto?</p>
